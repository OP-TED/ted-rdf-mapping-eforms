...
*Mapping Project* See _Mapping Suite_.

*Mapping Suite* A repository containing a set of RML mapping packages for XML-RDF conversion, along with supporting artefacts. Interchangeable with _Mapping Project_.

*Mapping Package* A set of RML mapping rules for XML-RDF conversion, along with related resources. Mapping packages are part of a _Mapping Suite_.
